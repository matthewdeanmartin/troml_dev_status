...
1. **Create a Virtual Environment:** It's highly recommended to work inside a Python virtual environment.
...
1. **Install Dependencies:** Install the project in editable mode along with its development dependencies.

   ```bash
   pip install -e ".[dev]"
   ```

1. **Run the Tests:** Before making any changes, ensure all existing tests pass.
...
1. **Create a Branch:** Create a new branch for your changes.
   ...
   ```
1. **Commit Your Changes:** Make your changes and commit them with a clear, descriptive message.
   ```
   ...
   ```
1. **Push and Open a Pull Request:** Push your branch to your fork and open a pull request against the main repository.
