...
readonly SRC_DIR="./troml_dev_status"
readonly TMP_ROOT="/tmp"
readonly TMP_DIR="${TMP_ROOT}/troml_dev_status"
readonly OUTPUT_MD_BASENAME="troml_dev_status.flat.md"
...
# Run strip-docs for each subdirectory of tmp/troml_dev_status
...
# in the generated Markdown (troml_dev_status.flat.md). Other code fences remain untouched.
